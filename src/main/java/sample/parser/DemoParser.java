...
public class DemoParser extends AParser {
    ...
    /**
     * The parser breaks the contract and does not return a meaningful recipe.
     * This is ok since it is a demo parser.
    ...
    /**
     * The parser accepts all recipe texts with <code>hello</code> in name.
     * @param text The recipe as text.
