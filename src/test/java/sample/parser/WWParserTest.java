...
public class WWParserTest {
    ...
    public void setUp() throws Throwable {
        ...
        this.rawRecipeList.add(ResourceLoader.loadFileContents(this.getClass().getClassLoader(), "/sample/parser/WW_2015_test_zutaten.html"));
        this.rawRecipeList.add(ResourceLoader.loadFileContents(this.getClass().getClassLoader(), "/sample/parser/WW_2015_test_1.html"));
        this.rawRecipeList.add(ResourceLoader.loadFileContents(this.getClass().getClassLoader(), "/sample/parser/WW_2015_test_2.html"));
        this.rawRecipeList.add(ResourceLoader.loadFileContents(this.getClass().getClassLoader(), "/sample/parser/WW_2015_test_3.html"));
        this.rawRecipeList.add(ResourceLoader.loadFileContents(this.getClass(), "/sample/parser/WW_2016_test_zutaten.htm"));
        this.rawRecipeList.add(ResourceLoader.loadFileContents(this.getClass(), "/sample/parser/WW_2016_test_1.htm"));
        this.rawRecipeList.add(ResourceLoader.loadFileContents(this.getClass(), "/sample/parser/WW_2016_test_2.htm"));
        this.rawRecipeList.add(ResourceLoader.loadFileContents(this.getClass(), "/sample/parser/WW_2016_test_3.htm"));
    }
